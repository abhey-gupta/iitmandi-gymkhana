...
export default function Sidebar_ChairSAP() {
        ...
        <Sidebar.ItemGroup>
          ...
          >
            <Link
              ...
              href="/chair-sap/manage-recommendation-requests"
            >
              For recommendation
            </Link>
            <Link
              className="flex items-center rounded-lg px-3 py-2 gap-4 text-base font-normal text-gray-900 hover:bg-gray-100 pl-10"
              href="/chair-sap/manage-requests?filter=pending"
            >
              Pending
            </Link>
            ...
            <Link
              className="flex items-center rounded-lg px-3 py-2 gap-4 text-base font-normal text-gray-900 hover:bg-gray-100 pl-10"
              href="/chair-sap/manage-requests?filter=approved"
            >
              Approved
            </Link>
            ...
            <Link
              className="flex items-center rounded-lg px-3 py-2 gap-4 text-base font-normal text-gray-900 hover:bg-gray-100 pl-10"
              href="/chair-sap/manage-requests?filter=rejected"
            >
              Rejected
            </Link>
          </Sidebar.Collapse>
